...
import simpledb.local.LocalConnection;
import simpledb.local.LocalConnectionImpl;
import simpledb.local.LocalStatement;
...
public class LocalDriver {
    ...
    public static void main(String[] args) {
        ...
        LocalConnectionImpl conn = null;
        try {
            conn = new LocalConnectionImpl();
            LocalStatement stmt = conn.createStatement();
